...
public class RemoveTagActivity extends AppCompatActivity {
    ...
    private AdapterView.OnItemClickListener createOnItemClickListener() {
        return new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                buttonRemove.setTextColor(Color.parseColor("#2196F3"));
                textViewButtonInfo.setText("Please click buttons to remove this LandmarkNode.");
            }
        };
    }
            ...
            public void onClick(View v) {
                ...
                Runnable serverComm = new Runnable(){
                    ...
                    public void run() {
                        ...
                        final List<LandmarkNode> landmarkNodesAfterRemove = rc.getLandmarkNodeforRFID(rfidDec+"" /*1289711604214144l*/);
                        if(landmarkNodesAfterRemove.size() == list.getAdapter().getCount()-1){
                            runOnUiThread(new Runnable() {
                                ...
                                public void run() {
                                    ...
                                    textViewLandmarkNodeInfo.setText("Remove landmark node (" + rfidDec + ") successfully.");
                                    textViewButtonInfo.setText("");
                                    buttonRemove.setTextColor(Color.parseColor("#000000"));
                                    buttonRemove.setClickable(false);
                                }
                            });
                        }else{
                            Toast.makeText(RemoveTagActivity.this, "Unknown error.", Toast.LENGTH_SHORT).show();

                        }
                        currentLandmarkNode = null;
                    }
                };
                Thread t = new Thread(serverComm);
                t.start();
